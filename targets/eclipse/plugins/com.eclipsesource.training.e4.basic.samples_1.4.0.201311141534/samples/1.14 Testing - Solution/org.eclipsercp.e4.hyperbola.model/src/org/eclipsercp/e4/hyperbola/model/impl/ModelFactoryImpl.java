...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	...
	public ContactGroup createExampleModel() {
		ContactGroup root = createContactGroup();
		ContactGroup icq = createContactGroup();
		icq.setName("ICQ");
		Contact alice = createContact();
		alice.setName("Alice");
		icq.getContacts().add(alice);
		ContactGroup skype = createContactGroup();
		skype.setName("Skype");
		Contact bob = createContact();
		bob.setName("Bob");
		skype.getContacts().add(bob);
		root.getContacts().add(skype);
		root.getContacts().add(icq);
		
		ContactGroup subgroup = createContactGroup();
		icq.getContacts().add(subgroup);
		Contact subContact = createContact();
